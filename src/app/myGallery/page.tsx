...
const events = [
    ...
    // Tightened, cohesive central cluster positions surrounding the title card
    positions: [
...
export default function GalleryPage() {
  ...
  useEffect(() => {
    ...
    /* ============================================================
       SCROLLTRIGGER ENTRY/EXIT COLLAGE ANIMATION
       ============================================================ */
    ...
    /* ============================================================
       DYNAMIC HORIZONTAL SMOOTH SCROLL MECHANISM
       ============================================================ */
    function goToSlide(index: number, animate = true) {
      ...
      const slideWidth = window.innerWidth * 0.76;
    ...
    function openViewer(eventIndex: number, imageIndex: number) {
      ...
      ev.images.forEach((img, i) => {
        ...
        slide.style.left = `${12 + i * 80}vw`; 
        slide.style.top = '14vh';
        slide.style.width = '76vw';
        slide.style.height = '72vh';
        slide.innerHTML = `
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .hero-title { font-size: clamp(3.5rem, 8vw, 7rem); font-weight: 900; letter-spacing: -0.03em; line-height: 1.05; }
        .hero-title em { font-style: normal; color: var(--accent); text-shadow: 0 0 40px rgba(0, 119, 194, 0.2); }
        .hero-sub { color: var(--muted); font-size: 1.1rem; max-width: 48ch; margin-top: 2rem; line-height: 1.65; }
      ...
      <header id="hero-screen">
        ...
        <p className="hero-sub">Thru-scrolling our historic architecture index. click any asset card element to initiate targeted cinematic glide track sequences.</p>
      </header>

      <main id="stream" ref={streamRef}>
        {events.map((ev, ei) => (
          <section className="gallery-screen" key={ei}>
