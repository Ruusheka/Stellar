...
// Import ScrollToPlugin safely to handle smooth scrolling via GSAP
...
export default function GalleryPage() {
  ...
  useEffect(() => {
    ...
    /* ============================================================
       GSAP SOLAR SYSTEM ENGINE (FIXED POSITIONING MATRIX)
       ============================================================ */
    const planets = systemRef.current?.querySelectorAll('.planet-wrapper');
    if (planets) {
      planets.forEach((planet, index) => {
        // Explicitly set matching container dimensions dynamically to resolve stacking collapses
        const orbitDiameter = 220 + index * 140; 
        ...
        // Infinite rotation timeline for the outer orbital layout
        ...
        // Counter-rotation matrix to prevent the text from going upside down
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        /* Solar System Structural Layout Framework */
        .solar-system {
          position: relative;
          width: 600px;
          height: 600px;
